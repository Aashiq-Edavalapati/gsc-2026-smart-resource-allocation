  ...
  template: `
    <aside class="w-64 bg-card border-r border-border flex flex-col h-full">
      ...
      <div class="p-6 flex items-center gap-3">
        ...
        <span class="font-semibold text-lg tracking-tight text-foreground">NGOConnect</span>
      </div>
      ...
      <nav class="flex-1 px-3 py-2 space-y-1">
        ...
        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md bg-primary text-primary-foreground font-medium transition-colors shadow-sm">
        ...
        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground font-medium transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="px-3 py-4 space-y-1 border-t border-border">
        <div class="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2 px-3">General</div>
        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground font-medium transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
